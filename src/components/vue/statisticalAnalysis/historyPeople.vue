            ...
            <el-container class="h_100">
                <el-header class="searchbar searchHeader">
                    <el-row :gutter="20">
                        ...
                        <el-col :span="5" class="flex-parent">
                            ...
                            <div class="flex-child ipt">
                                <input type="text" v-model="parmas.name" placeholder="姓名" class="flex-center">
                            </div>
                        </el-col>
                        <el-col :span="5" class="flex-parent">
                            <label class="tit" style="width: 100px;">身份证号码：</label>
                            <div class="flex-child ipt">
                                <input type="text" v-model="parmas.identityNum" placeholder="身份证号码" class="flex-center">
                            </div>
                        </el-col>
                ...
                <el-main class="table-content">
                    <el-table :data="tableData" border ref="multipleTable"  style="width: 100%">
                        ...
                        <el-table-column prop="datetime" label="抓拍时间"></el-table-column>
                        <el-table-column prop="scoreRecg" label="相似度"></el-table-column>
                        <el-table-column prop="" label="抓拍图片">
                            <template slot-scope="scope">
                                <div class="td-img flex-mid-center">
                                    <img :src="imgUrl+scope.row.bgImage" alt="" onerror="this.src='../../../../static/img/default1.png'">
                                </div>
                            </template>
                        </el-table-column>
                        <el-table-column prop="" label="对比图片">
                            <template slot-scope="scope">
                                <div class="td-img flex-mid-center">
                                    <img :src="imgUrl+scope.row.image" alt="" onerror="this.src='../../../../static/img/default1.png'">
                                </div>
                            </template>
                        </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            getData(str) {
                ...
                this.$ajax({
                    method: "POST",
                    url: process.env.base+'his-Pedestrian-list',
                    dataType: "json",
                    data: this.parmas
                }).then(res => {
                    if (res.data.code == 0) {
